...
# ╔═╡ cc59324a-e697-4e7e-a0a5-c60b667cd203
...
begin
	...
	X2Size=Random.rand(Normal(0,1),n0,2)
...
# ╔═╡ a3ec6d98-07b0-4e96-a63e-b2c0de4d3568
md"""
### Three clusters with different distances
"""
...
begin
	...
	X2D=Random.rand(Normal(0,1),n0D,2)
	X3D=Random.rand(Normal(0,1),n0D,2)
...
# ╔═╡ 346a1426-fd3b-4204-9088-c119c59c368f
md"""
### Concentric circles
"""

# ╔═╡ 7ca11dcd-f131-4e50-b910-440a7d4b2b41
begin
	
	n0Con=200
	Random.seed!(123)
	X1Con=Random.rand(Normal(0,1),n0Con,n0Con)
	X2Con=Random.rand(Normal(0,50),n0Con,n0Con)
...
begin
		...
		t=collect(2*pi/nTr:2*pi/nTr:2*pi)

		XTr=[sin.(t)+2*sin.(2*t) cos.(t)-2*cos.(2*t) -sin.(3*t)]
...
# ╔═╡ 1f6b9888-04a4-4a2b-aa37-f5177ba23072
